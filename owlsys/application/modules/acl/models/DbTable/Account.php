...
class Acl_Model_DbTable_Account extends Zend_Db_Table_Abstract
{
     ...
     * @return boolean
     */
    public function login( Acl_Model_Account $account, $accountToValidate ) {
        ...
        $authAdapter->setIdentity( $account->getEmail() );
        $authAdapter->setCredential( crypt($account->getPassword(), $accountToValidate->password) );
